...
gene_list <- list("IFN" = IFN, "NEU" = neu_glist)
...
```{r}
seu_WB[["module_score"]] <- AddModuleScore(seu_WB, features = gene_list, name = names(gene_list))@meta.data |>
    tibble::rownames_to_column("cells") |> 
    dplyr::select(c(cells, 30:31)) |> 
    tidyr::pivot_longer(cols = 2:3, names_to = "source", values_to = "score") |> 
