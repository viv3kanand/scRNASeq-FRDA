...
neu_dge <- openxlsx::read.xlsx("../data/2024-09-26_DGE_sc_res_WB_filtered.xlsx", "Neutrophil")

neu_glist <- neu_dge[neu_dge$gene %in% neu_glist,]$gene

DoHeatmap(subset(seu_WB, idents = "Neutrophil"), features = neu_glist, cells = 1:5000, group.by = "Condition")
