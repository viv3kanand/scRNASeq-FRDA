...
h_list <- cowplot::plot_grid(plot_list$heatmap$iPSC,
...
P4 <- cowplot::ggdraw() + cowplot::draw_image("analysis/figures/Bulk/tom_plot.png")

P5 <- cowplot::ggdraw() + cowplot::draw_image("analysis/figures/Bulk/module_bulk.png")
