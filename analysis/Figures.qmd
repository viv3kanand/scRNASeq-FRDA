...
P3B <- ggplot(imb_df, aes(x = umapharmony_1, y = umapharmony_2, col = scores)) +
...
P3D <- colData(sce_cd14)[,c(1,2,3,7,8)] |>
  as.data.frame() |> 
...
P3CD <- cowplot::plot_grid(P3C, P3D, ncol = 1, labels = c("C", "D"), rel_widths = c(1, 1), axis = "bt", align = "hv")

P3BCD <- cowplot::plot_grid(P3B, P3CD, nrow = 1, labels = c("B"), rel_widths = c(1, 1))
...
P3EF <- cowplot::plot_grid(P3E, P3F, nrow = 1, labels = c("E", "F"))
