...
S1B <- DotPlot(seu_PBMC, features = markers_WB) + RotatedAxis()
...
markers_PBMC <- c("MKI67", "TOP2A", "CLEC4C", "NRP1", "FCER1A", "CLEC10A", "LYZ", "PPBP", "FCGR3A", "TNFRSF13B", "JCHAIN", "CD14", "KLRB1", "CD8A", "CD8B", "NKG7", "GNLY", "NCAM1", "CD79A", "MS4A1", "CD4", "CCR7", "ALPL", "MME")

P3B <- DotPlot(seu_PBMC, features = markers_PBMC) + RotatedAxis()

# Figure 3C - DEG-upset plot (all cell types)
