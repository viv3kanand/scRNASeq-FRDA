...
P3F <- cowplot::ggdraw() + cowplot::draw_image("figures/Panel3/AUC_image.png")
...
prop_df <- seu_PBMC@meta.data %>%
  group_by(Condition, IL10_active) %>%
  summarise(n = n(), .groups = 'drop') %>%
  group_by(Condition) %>%
  mutate(prop = n / sum(n))

P3G <- ggplot(seu_PBMC@meta.data, aes(x = Condition, fill = IL10_active)) +
    geom_bar(position = "fill") +
    scale_fill_manual(values = c("gray80", "tomato")) +
    ylab("Proportion of Cells") +
    ggtitle("IL-10 Active Cells per Condition")

cowplot::plot_grid(P4F, P4G, ncol)
...
P3H <- plot_density(seu_PBMC, "IL10_active", reduction = "umap.harmony", joint = FALSE) +
...
P3GH <- cowplot::plot_grid(P3F, P3G, nrow = 2, labels = c("F", "G"), align = "hv")

P3_bottom <- cowplot::plot_grid(P3GH, P3H, nrow = 1, labels = c("","H"),  rel_widths = c(0.4, 0.6))


P3_final <- cowplot::plot_grid(P3_top, P3_mid, P3_bottom, ncol = 1, align = "hv")
