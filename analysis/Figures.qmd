...
```{r}
# Volcano plot
dge_bulk <- read_csv("../data/DEseq2-gene-batch-corrected-14Nov22.csv", col_names = TRUE)
...
DoHeatmap(subset(seu_PBMC, subset = cell_type == "CD14 Mono"), features = neu_glist, cells = 1:30000, group.by = "Condition")
