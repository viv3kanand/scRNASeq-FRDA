...
P1 <- dge_bulk |> 
  ...
  geom_point(aes(color = Expression, alpha = 0.8, size = 2)) +
...
P2B <- cowplot::ggdraw() + cowplot::draw_image("figures/Bulk/WGCNA/manu-fig-02-A-TOMplot-30x30.png")

P2C <- cowplot::ggdraw() + cowplot::draw_image("figures/Bulk/WGCNA/manu-fig-02-C-boxplot-sig-padj-ME.png")
...
P2AB <- cowplot::plot_grid(P2A, P2B, ncol = 1, rel_heights = c(0.4, 1.1))
