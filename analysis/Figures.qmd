...
res_gsva[[1]] |> 
    ...
    filter(celltype %in% c("B cells", "CD8 T cells", "Cytotoxic cells", "DC", "Monocyte", "Neutrophils", "NK cells", "T cells", "T helper cells")) |> 
...
vst_mat <- vst_gsva |> tibble::column_to_rownames("symbol") |> as.matrix()

xcell2_res <- xCell2::xCell2Analysis(
  mix = vst_mat,
  xcell2object = ImmGenData.xCell2Ref, BPPARAM = MulticoreParam(workers = 40))
