...
gene_sets <- msigdbr::msigdbr(species = "Homo sapiens", subcategory = "CP:REACTOME")
gene_sets <- gene_sets[gene_sets$gene_symbol %in% rownames(seu_PBMC@assays$RNA@features@.Data),]
il10_glist <- gene_sets[gene_sets$gs_name == "REACTOME_INTERLEUKIN_10_SIGNALING", ]$gene_symbol
