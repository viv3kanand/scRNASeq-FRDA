...
S1B <- DotPlot(seu_WB, features = markers_WB) + 
  scale_colour_gradient2(low = "#D53E4F", mid = 'white', high = "#3288BD") +
  RotatedAxis() +
  custom_theme() +
...
p1 <- CS_CD14$CAD_NCAD$M3 |> 
  ...
  scale_color_gradientn(colours = c('#3288BD', '#FFFFFF'), limit = c(min(CS_CD14$CAD_NCAD$M3$p.adjust), max(CS_CD14$CAD_NCAD$M3$p.adjust)), na.value = "grey") +
  scale_y_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) +
  custom_theme()
...
p2 <- CS_CD14$CAD_NCAD$M9 |> 
  ...
  scale_color_gradientn(colours = c('#3288BD', '#FFFFFF'), limit = c(min(CS_CD14$CAD_NCAD$M9$p.adjust), max(CS_CD14$CAD_NCAD$M9$p.adjust)), na.value = "grey") +
  scale_y_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) +
  custom_theme()
...
p3 <- CS_CD14$CAD_NCAD$M15 |> 
    ...
    scale_color_gradientn(colours = c('#3288BD', '#FFFFFF'), limit = c(min(CS_CD14$CAD_NCAD$M15$p.adjust), max(CS_CD14$CAD_NCAD$M15$p.adjust)), na.value = "grey") +
    scale_y_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) +
    custom_theme()
