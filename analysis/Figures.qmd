...
### Panel 2: scRNA-Seq - PBMC & WB summary
...
P2_top <- cowplot::plot_grid(P2A, P2B, P2C, nrow = 1, labels = "AUTO", rel_widths = c(0.8, 1, 0.8), axis = "b", align = "hv")
...
P2_bottom <- cowplot::plot_grid(P2D, P2E, P2F, nrow = 1, labels = c("D", "E", "F"), rel_widths = c(0.8, 1, 1), axis = "b", align = "hv")


P2_final <- cowplot::plot_grid(P2_left, P2_mid, P2_right, nrow = 1, rel_widths = c(0.8, 1, 0.8))
