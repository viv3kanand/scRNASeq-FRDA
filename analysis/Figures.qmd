...
P3BCD <- cowplot::plot_grid(P3B, P3CD, nrow = 1, labels = c("B"), rel_widths = c(0.8, 1), axis = "lr", align = "v")
...
P3_bottom <- cowplot::plot_grid(P3E, P3F, P3G, nrow = 1, labels = c("E", "F", "G"), axis = "bt", align = "h")
