...
fig1AB <- cowplot::ggdraw() + cowplot::draw_image("figures/Bulk/fig1AB.png")
fig1CD <- cowplot::ggdraw() + cowplot::draw_image("figures/Bulk/fig1CD.png")
...
ggsave(filename = "figures/Bulk/fig2C.png", 
       plot = P2C,
       units = "in", 
       width = 8.5/2,
       height = 13/4,
