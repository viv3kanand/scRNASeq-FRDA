...
subset.cd14 <- subset(seu_WB, idents = "CD14 Mono")
Idents(subset.cd14) <- "Condition"
avg.cd14.mono <- log1p(AverageExpression(subset.cd14, verbose = FALSE)$RNA) |> as.data.frame()
avg.cd14.mono$gene <- rownames(avg.cd14.mono)

genes.to.label = c("FXN", "ISG15", "LY6E", "IFI6", "ISG20", "MX1", "IFIT2", "IFIT1", "CXCL10", "CCL8")

p <- ggplot(avg.cd14.mono, aes(Control, Patient)) + geom_point() + ggtitle("CD14 Mono")
