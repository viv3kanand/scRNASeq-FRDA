...
file <- "RData/gsea/2024-09-26_GSEA_REACTOME.xlsx"

sheets <- openxlsx::getSheetNames(file)

REACTOME_CD14 <- openxlsx::read.xlsx(file, "CD14 Mono")
...
REACTOME_CD14 |> 
  ...
  dplyr::slice( unique(c(1:10, n() - 0:9)) ) |> 
  dplyr::arrange(NES) |> 
  dplyr::mutate(ID = stringr::str_sub(ID, 10) |> 
