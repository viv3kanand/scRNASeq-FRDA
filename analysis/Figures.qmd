...
P3DE <- cowplot::plot_grid(P3D, P3E, nrow = 1, labels = c("D", "E"))
...
P4G <- ggplot(seu_PBMC@meta.data, aes(x = Condition, fill = IL10_active)) +
...
P4H <- plot_density(seu_PBMC, "IL10_active", reduction = "umap.harmony", joint = FALSE) +
...
P3GH <- cowplot::plot_grid(P3G, P3H, nrow = 2, labels = c("G", "H"))

P3_bottom <- cowplot::plot_grid(P3EF, P3GH, nrow = 1, rel_widths = c(0.8, 0.3))
...
P3_final <- cowplot::plot_grid(P3_top, P3_bottom, ncol = 1, align = "hv")
...
P4E <- Nebulosa::plot_density(seu_WB_neu, 
             features = "IFN1", 
             joint = FALSE, 
             combine = TRUE,
             size = 0.5) + 
...
P4FGH <- plot_density(seu_WB_neu, c("LY6E", "STAT1"), joint = TRUE, combine = TRUE, size = 0.5)
...
P4_bottom <- cowplot::plot_grid(P4E, P4F, P4G, P4H, nrow = 1, align = "v", axis = "tb", labels = c("E", "F", "G", "H"))
