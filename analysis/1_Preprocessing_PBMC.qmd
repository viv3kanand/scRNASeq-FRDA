...
li_b1 <- list.files("../data/PBMC/B1/", pattern = "h5")

purrr::imap(setNames(li_b1, gsub(pattern = "_filtered_feature_bc_matrix.h5", 
                              replacement = "", li_b1)), 
            function(obj, name){
              Seurat::Read10X_h5(paste0("../data/PBMC/B1/", obj)) |> 
                Seurat::CreateSeuratObject(min.cells = 3,
                                           project = paste0(name, "B1"))
}) -> B1

li_b2 <- list.files("../data/PBMC/B2/", pattern = "h5")

purrr::imap(setNames(li_b2, gsub(pattern = "_filtered_feature_bc_matrix.h5", 
                              replacement = "", li_b2)), 
            function(obj, name){
              Seurat::Read10X_h5(paste0("../data/PBMC/B2/", obj)) |> 
                Seurat::CreateSeuratObject(min.cells = 3,
                                           project = paste0(name, "B2"))
}) -> B2
